...
public class CreateLeadUsingAdvancedXPath {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//td/input[@id='createLeadForm_lastName']")).sendKeys("Bharath");
 
		// Enter an first name using ancestor - grandparent to child xpath
		driver.findElement(By.xpath("//tr//input[@id='createLeadForm_firstName']")).sendKeys("Aswin");
